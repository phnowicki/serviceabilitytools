#===============================================================================
#
# FILE: serviceabilitytools.IMP.Cisco Presence Datastore.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco Presence Datastore" service
	...
	Scenario: Restart "Cisco Presence Datastore" service that is stopped
	When we submit a request to restart "Cisco Presence Datastore" service
	And the "Cisco Presence Datastore" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco Presence Datastore" service should be "STARTED"
	...
	Scenario: Start "Cisco Presence Datastore" service that is already started
	When we submit a request to start "Cisco Presence Datastore" service
	And the "Cisco Presence Datastore" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco Presence Datastore" service should be "STARTED"

	Scenario: Stop "Cisco Presence Datastore" service that is already stopped
	When we submit a request to stop "Cisco Presence Datastore" service
	And the "Cisco Presence Datastore" service is "stopped"
