#===============================================================================
#
# FILE: serviceabilitytools.IMP.Cisco XCP Message Archiver.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco XCP Message Archiver" service
	...
	Scenario: Restart "Cisco XCP Message Archiver" service that is stopped
	When we submit a request to restart "Cisco XCP Message Archiver" service
	And the "Cisco XCP Message Archiver" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco XCP Message Archiver" service should be "STARTED"
	...
	Scenario: Start "Cisco XCP Message Archiver" service that is already started
	When we submit a request to start "Cisco XCP Message Archiver" service
	And the "Cisco XCP Message Archiver" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco XCP Message Archiver" service should be "STARTED"

	Scenario: Stop "Cisco XCP Message Archiver" service that is already stopped
	When we submit a request to stop "Cisco XCP Message Archiver" service
	And the "Cisco XCP Message Archiver" service is "stopped"
