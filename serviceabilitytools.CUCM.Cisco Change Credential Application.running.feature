#===============================================================================
#
# FILE: serviceabilitytools.CUCM.Cisco Change Credential Application.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco Change Credential Application" service
	...
	Scenario: Restart "Cisco Change Credential Application" service that is stopped
	When we submit a request to restart "Cisco Change Credential Application" service
	And the "Cisco Change Credential Application" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco Change Credential Application" service should be "STARTED"
	...
	Scenario: Start "Cisco Change Credential Application" service that is already started
	When we submit a request to start "Cisco Change Credential Application" service
	And the "Cisco Change Credential Application" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco Change Credential Application" service should be "STARTED"

	Scenario: Stop "Cisco Change Credential Application" service that is already stopped
	When we submit a request to stop "Cisco Change Credential Application" service
	And the "Cisco Change Credential Application" service is "stopped"
