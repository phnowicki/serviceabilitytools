#===============================================================================
#
# FILE: serviceabilitytools.CUCM.Cisco CAR Web Service.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco CAR Web Service" service
	...
	Scenario: Restart "Cisco CAR Web Service" service that is stopped
	When we submit a request to restart "Cisco CAR Web Service" service
	And the "Cisco CAR Web Service" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco CAR Web Service" service should be "STARTED"
	...
	Scenario: Start "Cisco CAR Web Service" service that is already started
	When we submit a request to start "Cisco CAR Web Service" service
	And the "Cisco CAR Web Service" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco CAR Web Service" service should be "STARTED"

	Scenario: Stop "Cisco CAR Web Service" service that is already stopped
	When we submit a request to stop "Cisco CAR Web Service" service
	And the "Cisco CAR Web Service" service is "stopped"
