#===============================================================================
#
# FILE: serviceabilitytools.CUCM.Cisco Extension Mobility Application.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco Extension Mobility Application" service
	...
	Scenario: Restart "Cisco Extension Mobility Application" service that is stopped
	When we submit a request to restart "Cisco Extension Mobility Application" service
	And the "Cisco Extension Mobility Application" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco Extension Mobility Application" service should be "STARTED"
	...
	Scenario: Start "Cisco Extension Mobility Application" service that is already started
	When we submit a request to start "Cisco Extension Mobility Application" service
	And the "Cisco Extension Mobility Application" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco Extension Mobility Application" service should be "STARTED"

	Scenario: Stop "Cisco Extension Mobility Application" service that is already stopped
	When we submit a request to stop "Cisco Extension Mobility Application" service
	And the "Cisco Extension Mobility Application" service is "stopped"
