#===============================================================================
#
# FILE: serviceabilitytools.CUCM.Cisco CTI Manager.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco CTI Manager" service
	...
	Scenario: Restart "Cisco CTI Manager" service that is stopped
	When we submit a request to restart "Cisco CTI Manager" service
	And the "Cisco CTI Manager" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco CTI Manager" service should be "STARTED"
	...
	Scenario: Start "Cisco CTI Manager" service that is already started
	When we submit a request to start "Cisco CTI Manager" service
	And the "Cisco CTI Manager" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco CTI Manager" service should be "STARTED"

	Scenario: Stop "Cisco CTI Manager" service that is already stopped
	When we submit a request to stop "Cisco CTI Manager" service
	And the "Cisco CTI Manager" service is "stopped"
