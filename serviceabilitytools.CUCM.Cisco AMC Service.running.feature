#===============================================================================
#
# FILE: serviceabilitytools.CUCM.Cisco AMC Service.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco AMC Service" service
	...
	Scenario: Restart "Cisco AMC Service" service that is stopped
	When we submit a request to restart "Cisco AMC Service" service
	And the "Cisco AMC Service" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco AMC Service" service should be "STARTED"
	...
	Scenario: Start "Cisco AMC Service" service that is already started
	When we submit a request to start "Cisco AMC Service" service
	And the "Cisco AMC Service" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco AMC Service" service should be "STARTED"

	Scenario: Stop "Cisco AMC Service" service that is already stopped
	When we submit a request to stop "Cisco AMC Service" service
	And the "Cisco AMC Service" service is "stopped"
