...
package CiscoUC::RIS::10_5::Elements::selectCmDeviceSIPResponse;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'selectCmDeviceSIPResponse' => 'CiscoUC::RIS::10_5::Types::selectCmDeviceSIPReturn',
    },
    {
...
CiscoUC::RIS::10_5::Elements::selectCmDeviceSIPResponse
...
=head2 new
 ...
 my $element = CiscoUC::RIS::10_5::Elements::selectCmDeviceSIPResponse->new($data);

Constructor. The following data structure may be passed to new():

 {
   selectCmDeviceSIPResponse =>  { # CiscoUC::RIS::10_5::Types::selectCmDeviceSIPReturn
     SelectCmDeviceResultSIP =>  { # CiscoUC::RIS::10_5::Types::SelectCmDeviceResultSIP
       TotalDevicesFound =>  $some_value, # unsignedInt
       CmNodes =>  { # CiscoUC::RIS::10_5::Types::ArrayOfCmNodeSIP
