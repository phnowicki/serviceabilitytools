package CiscoUC::RIS::10_5::Types::SelectCmDeviceResult;
use strict;
use warnings;
...
CiscoUC::RIS::10_5::Types::SelectCmDeviceResult

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
SelectCmDeviceResult from the namespace http://schemas.cisco.com/ast/soap.
