package CiscoUC::RIS::10_5::Types::ArrayOfCmDevice;
use strict;
use warnings;
...
my %CmDevice_of :ATTR(:get<CmDevice>);
...
CiscoUC::RIS::10_5::Types::ArrayOfCmDevice

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
ArrayOfCmDevice from the namespace http://schemas.cisco.com/ast/soap.
