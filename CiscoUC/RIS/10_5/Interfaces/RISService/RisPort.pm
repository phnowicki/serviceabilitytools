package CiscoUC::RIS::10_5::Interfaces::RISService::RisPort;
use strict;
use warnings;
...
require CiscoUC::RIS::10_5::Typemaps::RISService
    if not CiscoUC::RIS::10_5::Typemaps::RISService->can('get_class');

sub START {
    $_[0]->set_proxy('https://192.168.1.47:8443/realtimeservice2/services/RISService') if not $_[2]->{proxy};
    $_[0]->set_class_resolver('CiscoUC::RIS::10_5::Typemaps::RISService')
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            ...
            encodingStyle   => '',
            parts           =>  [qw( CiscoUC::RIS::10_5::Elements::selectCmDevice )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( CiscoUC::RIS::10_5::Elements::selectCtiItem )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( CiscoUC::RIS::10_5::Elements::executeCCMSQLStatement )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( CiscoUC::RIS::10_5::Elements::getServerInfo )],
        },
        header => {
    ...
    return $self->SUPER::call({
        ...
        body => {
           ...
           'use'            => 'literal',
            namespace       => 'http://schemas.xmlsoap.org/wsdl/soap/',
            encodingStyle   => '',
            parts           =>  [qw( CiscoUC::RIS::10_5::Elements::selectCmDeviceSIP )],
        },
        header => {
...
CiscoUC::RIS::10_5::Interfaces::RISService::RisPort - SOAP Interface for the RISService Web Service

=head1 SYNOPSIS

 use CiscoUC::RIS::10_5::Interfaces::RISService::RisPort;
 my $interface = CiscoUC::RIS::10_5::Interfaces::RISService::RisPort->new();
...
located at https://192.168.1.47:8443/realtimeservice2/services/RISService.
...
Returns a L<CiscoUC::RIS::10_5::Elements::selectCmDeviceResponse|CiscoUC::RIS::10_5::Elements::selectCmDeviceResponse> object.

 $response = $interface->selectCmDevice( {
    StateInfo =>  $some_value, # string
    CmSelectionCriteria =>  { # CiscoUC::RIS::10_5::Types::CmSelectionCriteria
...
Returns a L<CiscoUC::RIS::10_5::Elements::selectCtiItemResponse|CiscoUC::RIS::10_5::Elements::selectCtiItemResponse> object.
...
Returns a L<CiscoUC::RIS::10_5::Elements::executeCCMSQLStatementResponse|CiscoUC::RIS::10_5::Elements::executeCCMSQLStatementResponse> object.
...
Returns a L<CiscoUC::RIS::10_5::Elements::getServerInfoResponse|CiscoUC::RIS::10_5::Elements::getServerInfoResponse> object.

 $response = $interface->getServerInfo( {
    Hosts =>  { # CiscoUC::RIS::10_5::Types::Hosts
...
Returns a L<CiscoUC::RIS::10_5::Elements::selectCmDeviceSIPResponse|CiscoUC::RIS::10_5::Elements::selectCmDeviceSIPResponse> object.
...
Generated by SOAP::WSDL on Sat Sep  6 22:24:24 2014
