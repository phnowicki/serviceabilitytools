...
package CiscoUC::RIS::10_0::Elements::selectCmDeviceSIPResponse;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'selectCmDeviceSIPResponse' => 'CiscoUC::RIS::10_0::Types::selectCmDeviceSIPReturn',
    },
    {
...
CiscoUC::RIS::10_0::Elements::selectCmDeviceSIPResponse
...
=head2 new
 ...
 my $element = CiscoUC::RIS::10_0::Elements::selectCmDeviceSIPResponse->new($data);

Constructor. The following data structure may be passed to new():

 {
   selectCmDeviceSIPResponse =>  { # CiscoUC::RIS::10_0::Types::selectCmDeviceSIPReturn
     SelectCmDeviceResultSIP =>  { # CiscoUC::RIS::10_0::Types::SelectCmDeviceResultSIP
       TotalDevicesFound =>  $some_value, # unsignedInt
       CmNodes =>  { # CiscoUC::RIS::10_0::Types::ArrayOfCmNodeSIP
         CmNodeSIP =>  { # CiscoUC::RIS::10_0::Types::CmNodeSIP
           ReturnCode => $some_value, # RisReturnCode
           Name =>  $some_value, # string
           NoChange =>  $some_value, # boolean
           CmDevices =>  { # CiscoUC::RIS::10_0::Types::ArrayOfCmDeviceSIP
             item =>  { # CiscoUC::RIS::10_0::Types::CmDeviceSIP
               Name =>  $some_value, # string
