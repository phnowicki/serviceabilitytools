...
package CiscoUC::RIS::10_0::Elements::selectCmDeviceSIP;
use strict;
use warnings;
...
CiscoUC::RIS::10_0::Elements::selectCmDeviceSIP
...
=head2 new
 ...
 my $element = CiscoUC::RIS::10_0::Elements::selectCmDeviceSIP->new($data);
