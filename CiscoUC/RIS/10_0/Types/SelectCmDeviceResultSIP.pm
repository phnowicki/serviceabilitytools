package CiscoUC::RIS::10_0::Types::SelectCmDeviceResultSIP;
use strict;
use warnings;
...
my %TotalDevicesFound_of :ATTR(:get<TotalDevicesFound>);
my %CmNodes_of :ATTR(:get<CmNodes>);

__PACKAGE__->_factory(
    [ qw(        TotalDevicesFound
        CmNodes

    ) ],
    {
        'TotalDevicesFound' => \%TotalDevicesFound_of,
        'CmNodes' => \%CmNodes_of,
    },
    {
        'TotalDevicesFound' => 'SOAP::WSDL::XSD::Typelib::Builtin::unsignedInt',
        'CmNodes' => 'CiscoUC::RIS::10_0::Types::ArrayOfCmNodeSIP',
    },
    {

        'TotalDevicesFound' => 'TotalDevicesFound',
        'CmNodes' => 'CmNodes',
    }
);
...
CiscoUC::RIS::10_0::Types::SelectCmDeviceResultSIP

=head1 DESCRIPTION

Perl data type class for the XML Schema defined complexType
SelectCmDeviceResultSIP from the namespace http://schemas.cisco.com/ast/soap.
