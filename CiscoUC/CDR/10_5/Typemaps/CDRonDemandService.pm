...
package CiscoUC::CDR::10_5::Typemaps::CDRonDemandService;
use strict;
use warnings;

our $typemap_1 = {
               'get_file' => 'CiscoUC::CDR::10_5::Elements::get_file',
               'get_file/in2' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
               'get_file_listResponse/get_file_listReturn' => 'CiscoUC::CDR::10_5::Types::ArrayOfFileName',
               'get_file_listResponse' => 'CiscoUC::CDR::10_5::Elements::get_file_listResponse',
               'get_file/in1' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
               'Fault/faultcode' => 'SOAP::WSDL::XSD::Typelib::Builtin::anyURI',
               'get_file/in4' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
               'get_fileResponse' => 'CiscoUC::CDR::10_5::Elements::get_fileResponse',
               'Fault/faultstring' => 'SOAP::WSDL::XSD::Typelib::Builtin::string',
               'Fault' => 'SOAP::WSDL::SOAP::Typelib::Fault11',
               'get_file/in5' => 'SOAP::WSDL::XSD::Typelib::Builtin::boolean',
               'get_file_list' => 'CiscoUC::CDR::10_5::Elements::get_file_list',
...
CiscoUC::CDR::10_5::Typemaps::CDRonDemandService - typemap for CDRonDemandService
