...
package CiscoUC::Log::10_0::Elements::listNodeServiceLogsResponse;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'listNodeServiceLogsReturn' => 'CiscoUC::Log::10_0::Types::NodeServiceLogList',
    },
    {
...
CiscoUC::Log::10_0::Elements::listNodeServiceLogsResponse
...
=head2 new
 ...
 my $element = CiscoUC::Log::10_0::Elements::listNodeServiceLogsResponse->new($data);
...
Constructor. The following data structure may be passed to new():

 {
   listNodeServiceLogsReturn =>  { # CiscoUC::Log::10_0::Types::NodeServiceLogList
     ...
     ServiceLog =>  { # CiscoUC::Log::10_0::Types::ArrayOfServiceLog
       item =>  $some_value, # string
     },
     SystemLog =>  { # CiscoUC::Log::10_0::Types::ArrayOfSystemLog
       item =>  $some_value, # string
     },
   },
 },
