...
package CiscoUC::Serviceability::9_1::Elements::soapGetStaticServiceListResponse;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'soapGetStaticServiceListReturn' => 'CiscoUC::Serviceability::9_1::Types::StaticServiceList',
    },
    {
...
CiscoUC::Serviceability::9_1::Elements::soapGetStaticServiceListResponse
...
=head2 new
 ...
 my $element = CiscoUC::Serviceability::9_1::Elements::soapGetStaticServiceListResponse->new($data);

Constructor. The following data structure may be passed to new():

 {
   soapGetStaticServiceListReturn =>  { # CiscoUC::Serviceability::9_1::Types::StaticServiceList
     Services =>  { # CiscoUC::Serviceability::9_1::Types::ArrayOfServiceSpecification
       item =>  { # CiscoUC::Serviceability::9_1::Types::ServiceSpecification
