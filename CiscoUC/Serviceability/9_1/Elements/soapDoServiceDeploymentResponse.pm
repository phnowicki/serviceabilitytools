...
package CiscoUC::Serviceability::9_1::Elements::soapDoServiceDeploymentResponse;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'soapDoServiceDeploymentReturn' => 'CiscoUC::Serviceability::9_1::Types::ServiceInformationResponse',
    },
    {
...
CiscoUC::Serviceability::9_1::Elements::soapDoServiceDeploymentResponse
...
=head2 new
 ...
 my $element = CiscoUC::Serviceability::9_1::Elements::soapDoServiceDeploymentResponse->new($data);
