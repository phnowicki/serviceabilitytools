...
package CiscoUC::Serviceability::9_1::Elements::getProductInformationListResponse;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'getProductInformationListReturn' => 'CiscoUC::Serviceability::9_1::Types::GetProductInformationListResponse',
    },
    {
...
CiscoUC::Serviceability::9_1::Elements::getProductInformationListResponse
...
=head2 new
 ...
 my $element = CiscoUC::Serviceability::9_1::Elements::getProductInformationListResponse->new($data);
...
Constructor. The following data structure may be passed to new():

 {
   getProductInformationListReturn =>  { # CiscoUC::Serviceability::9_1::Types::GetProductInformationListResponse
     ...
     Products =>  { # CiscoUC::Serviceability::9_1::Types::ArrayOfInstalledProduct
       item =>  { # CiscoUC::Serviceability::9_1::Types::InstalledProduct
     ...
     Services =>  { # CiscoUC::Serviceability::9_1::Types::ArrayOfProductServiceSpecification
       item =>  { # CiscoUC::Serviceability::9_1::Types::ProductServiceSpecification
         ServiceName =>  $some_value, # string
         ServiceType => $some_value, # ServiceTypes
         Deployable =>  $some_value, # boolean
         GroupName =>  $some_value, # string
         ProductID =>  $some_value, # string
         DependentServices =>  { # CiscoUC::Serviceability::9_1::Types::DependentServices
