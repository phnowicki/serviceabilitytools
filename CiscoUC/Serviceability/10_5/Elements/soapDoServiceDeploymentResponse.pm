...
package CiscoUC::Serviceability::10_5::Elements::soapDoServiceDeploymentResponse;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'soapDoServiceDeploymentReturn' => 'CiscoUC::Serviceability::10_5::Types::ServiceInformationResponse',
    },
    {
...
CiscoUC::Serviceability::10_5::Elements::soapDoServiceDeploymentResponse
...
=head2 new
 ...
 my $element = CiscoUC::Serviceability::10_5::Elements::soapDoServiceDeploymentResponse->new($data);
