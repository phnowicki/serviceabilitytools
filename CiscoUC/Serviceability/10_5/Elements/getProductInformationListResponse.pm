...
package CiscoUC::Serviceability::10_5::Elements::getProductInformationListResponse;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'getProductInformationListReturn' => 'CiscoUC::Serviceability::10_5::Types::GetProductInformationListResponse',
    },
    {
...
CiscoUC::Serviceability::10_5::Elements::getProductInformationListResponse
...
=head2 new
 ...
 my $element = CiscoUC::Serviceability::10_5::Elements::getProductInformationListResponse->new($data);
...
Constructor. The following data structure may be passed to new():

 {
   getProductInformationListReturn =>  { # CiscoUC::Serviceability::10_5::Types::GetProductInformationListResponse
     ...
     Products =>  { # CiscoUC::Serviceability::10_5::Types::ArrayOfInstalledProduct
       item =>  { # CiscoUC::Serviceability::10_5::Types::InstalledProduct
     ...
     Services =>  { # CiscoUC::Serviceability::10_5::Types::ArrayOfProductServiceSpecification
