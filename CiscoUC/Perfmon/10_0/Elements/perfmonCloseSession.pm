...
package CiscoUC::Perfmon::10_0::Elements::perfmonCloseSession;
use strict;
use warnings;
...
CiscoUC::Perfmon::10_0::Elements::perfmonCloseSession
...
=head2 new
 ...
 my $element = CiscoUC::Perfmon::10_0::Elements::perfmonCloseSession->new($data);
