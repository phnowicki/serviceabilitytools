...
package CiscoUC::Perfmon::9_1::Elements::perfmonRemoveCounterResponse;
use strict;
use warnings;
...
CiscoUC::Perfmon::9_1::Elements::perfmonRemoveCounterResponse
...
=head2 new
 ...
 my $element = CiscoUC::Perfmon::9_1::Elements::perfmonRemoveCounterResponse->new($data);
