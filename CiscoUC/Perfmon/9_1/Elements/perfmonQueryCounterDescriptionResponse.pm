...
package CiscoUC::Perfmon::9_1::Elements::perfmonQueryCounterDescriptionResponse;
use strict;
use warnings;
...
CiscoUC::Perfmon::9_1::Elements::perfmonQueryCounterDescriptionResponse
...
=head2 new
 ...
 my $element = CiscoUC::Perfmon::9_1::Elements::perfmonQueryCounterDescriptionResponse->new($data);
