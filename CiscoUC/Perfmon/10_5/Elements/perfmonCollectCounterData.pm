...
package CiscoUC::Perfmon::10_5::Elements::perfmonCollectCounterData;
use strict;
use warnings;
...
CiscoUC::Perfmon::10_5::Elements::perfmonCollectCounterData
...
=head2 new
 ...
 my $element = CiscoUC::Perfmon::10_5::Elements::perfmonCollectCounterData->new($data);
