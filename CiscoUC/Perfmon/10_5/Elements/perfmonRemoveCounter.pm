...
package CiscoUC::Perfmon::10_5::Elements::perfmonRemoveCounter;
use strict;
use warnings;
...
CiscoUC::Perfmon::10_5::Elements::perfmonRemoveCounter
...
=head2 new
 ...
 my $element = CiscoUC::Perfmon::10_5::Elements::perfmonRemoveCounter->new($data);
