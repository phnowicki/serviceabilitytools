...
package CiscoUC::Perfmon::10_5::Elements::perfmonRemoveCounterResponse;
use strict;
use warnings;
...
CiscoUC::Perfmon::10_5::Elements::perfmonRemoveCounterResponse
...
=head2 new
 ...
 my $element = CiscoUC::Perfmon::10_5::Elements::perfmonRemoveCounterResponse->new($data);
