#===============================================================================
#
# FILE: serviceabilitytools.CUCM.Cisco Bulk Provisioning Service.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco Bulk Provisioning Service" service
	...
	Scenario: Restart "Cisco Bulk Provisioning Service" service that is stopped
	When we submit a request to restart "Cisco Bulk Provisioning Service" service
	And the "Cisco Bulk Provisioning Service" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco Bulk Provisioning Service" service should be "STARTED"
	...
	Scenario: Start "Cisco Bulk Provisioning Service" service that is already started
	When we submit a request to start "Cisco Bulk Provisioning Service" service
	And the "Cisco Bulk Provisioning Service" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco Bulk Provisioning Service" service should be "STARTED"

	Scenario: Stop "Cisco Bulk Provisioning Service" service that is already stopped
	When we submit a request to stop "Cisco Bulk Provisioning Service" service
	And the "Cisco Bulk Provisioning Service" service is "stopped"
