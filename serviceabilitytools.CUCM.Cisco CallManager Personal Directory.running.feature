#===============================================================================
#
# FILE: serviceabilitytools.CUCM.Cisco CallManager Personal Directory.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco CallManager Personal Directory" service
	...
	Scenario: Restart "Cisco CallManager Personal Directory" service that is stopped
	When we submit a request to restart "Cisco CallManager Personal Directory" service
	And the "Cisco CallManager Personal Directory" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco CallManager Personal Directory" service should be "STARTED"
	...
	Scenario: Start "Cisco CallManager Personal Directory" service that is already started
	When we submit a request to start "Cisco CallManager Personal Directory" service
	And the "Cisco CallManager Personal Directory" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco CallManager Personal Directory" service should be "STARTED"

	Scenario: Stop "Cisco CallManager Personal Directory" service that is already stopped
	When we submit a request to stop "Cisco CallManager Personal Directory" service
	And the "Cisco CallManager Personal Directory" service is "stopped"
