#===============================================================================
#
# FILE: serviceabilitytools.CUCM.Cisco Unified Mobile Voice Access Service.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco Unified Mobile Voice Access Service" service
	...
	Scenario: Restart "Cisco Unified Mobile Voice Access Service" service that is stopped
	When we submit a request to restart "Cisco Unified Mobile Voice Access Service" service
	And the "Cisco Unified Mobile Voice Access Service" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco Unified Mobile Voice Access Service" service should be "STARTED"
	...
	Scenario: Start "Cisco Unified Mobile Voice Access Service" service that is already started
	When we submit a request to start "Cisco Unified Mobile Voice Access Service" service
	And the "Cisco Unified Mobile Voice Access Service" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco Unified Mobile Voice Access Service" service should be "STARTED"

	Scenario: Stop "Cisco Unified Mobile Voice Access Service" service that is already stopped
	When we submit a request to stop "Cisco Unified Mobile Voice Access Service" service
	And the "Cisco Unified Mobile Voice Access Service" service is "stopped"
