#===============================================================================
#
# FILE: serviceabilitytools.CUCM.Cisco CDP.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco CDP" service
	...
	Scenario: Restart "Cisco CDP" service that is stopped
	When we submit a request to restart "Cisco CDP" service
	And the "Cisco CDP" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco CDP" service should be "STARTED"
	...
	Scenario: Start "Cisco CDP" service that is already started
	When we submit a request to start "Cisco CDP" service
	And the "Cisco CDP" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco CDP" service should be "STARTED"

	Scenario: Stop "Cisco CDP" service that is already stopped
	When we submit a request to stop "Cisco CDP" service
	And the "Cisco CDP" service is "stopped"
