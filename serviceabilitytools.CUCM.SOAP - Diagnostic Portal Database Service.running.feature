#===============================================================================
#
# FILE: serviceabilitytools.CUCM.SOAP - Diagnostic Portal Database Service.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "SOAP - Diagnostic Portal Database Service" service
	...
	Scenario: Restart "SOAP - Diagnostic Portal Database Service" service that is stopped
	When we submit a request to restart "SOAP - Diagnostic Portal Database Service" service
	And the "SOAP - Diagnostic Portal Database Service" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "SOAP - Diagnostic Portal Database Service" service should be "STARTED"
	...
	Scenario: Start "SOAP - Diagnostic Portal Database Service" service that is already started
	When we submit a request to start "SOAP - Diagnostic Portal Database Service" service
	And the "SOAP - Diagnostic Portal Database Service" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "SOAP - Diagnostic Portal Database Service" service should be "STARTED"

	Scenario: Stop "SOAP - Diagnostic Portal Database Service" service that is already stopped
	When we submit a request to stop "SOAP - Diagnostic Portal Database Service" service
	And the "SOAP - Diagnostic Portal Database Service" service is "stopped"
