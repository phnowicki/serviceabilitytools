#===============================================================================
#
# FILE: serviceabilitytools.CUCM.Cisco AXL Web Service.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco AXL Web Service" service
	...
	Scenario: Restart "Cisco AXL Web Service" service that is stopped
	When we submit a request to restart "Cisco AXL Web Service" service
	And the "Cisco AXL Web Service" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco AXL Web Service" service should be "STARTED"
	...
	Scenario: Start "Cisco AXL Web Service" service that is already started
	When we submit a request to start "Cisco AXL Web Service" service
	And the "Cisco AXL Web Service" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco AXL Web Service" service should be "STARTED"

	Scenario: Stop "Cisco AXL Web Service" service that is already stopped
	When we submit a request to stop "Cisco AXL Web Service" service
	And the "Cisco AXL Web Service" service is "stopped"
