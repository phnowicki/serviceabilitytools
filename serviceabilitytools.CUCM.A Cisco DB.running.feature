#===============================================================================
#
# FILE: serviceabilitytools.CUCM.A Cisco DB.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "A Cisco DB" service
	...
	Scenario: Restart "A Cisco DB" service that is stopped
	When we submit a request to restart "A Cisco DB" service
	And the "A Cisco DB" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "A Cisco DB" service should be "STARTED"
	...
	Scenario: Start "A Cisco DB" service that is already started
	When we submit a request to start "A Cisco DB" service
	And the "A Cisco DB" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "A Cisco DB" service should be "STARTED"

	Scenario: Stop "A Cisco DB" service that is already stopped
	When we submit a request to stop "A Cisco DB" service
	And the "A Cisco DB" service is "stopped"
