#===============================================================================
#
# FILE: serviceabilitytools.CUCM.Cisco IP Voice Media Streaming App.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco IP Voice Media Streaming App" service
	...
	Scenario: Restart "Cisco IP Voice Media Streaming App" service that is stopped
	When we submit a request to restart "Cisco IP Voice Media Streaming App" service
	And the "Cisco IP Voice Media Streaming App" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco IP Voice Media Streaming App" service should be "STARTED"
	...
	Scenario: Start "Cisco IP Voice Media Streaming App" service that is already started
	When we submit a request to start "Cisco IP Voice Media Streaming App" service
	And the "Cisco IP Voice Media Streaming App" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco IP Voice Media Streaming App" service should be "STARTED"

	Scenario: Stop "Cisco IP Voice Media Streaming App" service that is already stopped
	When we submit a request to stop "Cisco IP Voice Media Streaming App" service
	And the "Cisco IP Voice Media Streaming App" service is "stopped"
