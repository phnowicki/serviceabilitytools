#===============================================================================
#
# FILE: serviceabilitytools.CUCM.Cisco CallManager Cisco IP Phone Services.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco CallManager Cisco IP Phone Services" service
	...
	Scenario: Restart "Cisco CallManager Cisco IP Phone Services" service that is stopped
	When we submit a request to restart "Cisco CallManager Cisco IP Phone Services" service
	And the "Cisco CallManager Cisco IP Phone Services" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco CallManager Cisco IP Phone Services" service should be "STARTED"
	...
	Scenario: Start "Cisco CallManager Cisco IP Phone Services" service that is already started
	When we submit a request to start "Cisco CallManager Cisco IP Phone Services" service
	And the "Cisco CallManager Cisco IP Phone Services" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco CallManager Cisco IP Phone Services" service should be "STARTED"

	Scenario: Stop "Cisco CallManager Cisco IP Phone Services" service that is already stopped
	When we submit a request to stop "Cisco CallManager Cisco IP Phone Services" service
	And the "Cisco CallManager Cisco IP Phone Services" service is "stopped"
