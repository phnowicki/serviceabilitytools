#===============================================================================
#
# FILE: serviceabilitytools.IMP.Cisco Intercluster Sync Agent.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco Intercluster Sync Agent" service
	...
	Scenario: Restart "Cisco Intercluster Sync Agent" service that is stopped
	When we submit a request to restart "Cisco Intercluster Sync Agent" service
	And the "Cisco Intercluster Sync Agent" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco Intercluster Sync Agent" service should be "STARTED"
	...
	Scenario: Start "Cisco Intercluster Sync Agent" service that is already started
	When we submit a request to start "Cisco Intercluster Sync Agent" service
	And the "Cisco Intercluster Sync Agent" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco Intercluster Sync Agent" service should be "STARTED"

	Scenario: Stop "Cisco Intercluster Sync Agent" service that is already stopped
	When we submit a request to stop "Cisco Intercluster Sync Agent" service
	And the "Cisco Intercluster Sync Agent" service is "stopped"
