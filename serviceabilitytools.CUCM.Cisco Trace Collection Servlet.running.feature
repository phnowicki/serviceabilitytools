#===============================================================================
#
# FILE: serviceabilitytools.CUCM.Cisco Trace Collection Servlet.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco Trace Collection Servlet" service
	...
	Scenario: Restart "Cisco Trace Collection Servlet" service that is stopped
	When we submit a request to restart "Cisco Trace Collection Servlet" service
	And the "Cisco Trace Collection Servlet" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco Trace Collection Servlet" service should be "STARTED"
	...
	Scenario: Start "Cisco Trace Collection Servlet" service that is already started
	When we submit a request to start "Cisco Trace Collection Servlet" service
	And the "Cisco Trace Collection Servlet" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco Trace Collection Servlet" service should be "STARTED"

	Scenario: Stop "Cisco Trace Collection Servlet" service that is already stopped
	When we submit a request to stop "Cisco Trace Collection Servlet" service
	And the "Cisco Trace Collection Servlet" service is "stopped"
