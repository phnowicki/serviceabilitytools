#===============================================================================
#
# FILE: serviceabilitytools.CUCM.Cisco CTL Provider.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco CTL Provider" service
	...
	Scenario: Restart "Cisco CTL Provider" service that is stopped
	When we submit a request to restart "Cisco CTL Provider" service
	And the "Cisco CTL Provider" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco CTL Provider" service should be "STARTED"
	...
	Scenario: Start "Cisco CTL Provider" service that is already started
	When we submit a request to start "Cisco CTL Provider" service
	And the "Cisco CTL Provider" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco CTL Provider" service should be "STARTED"

	Scenario: Stop "Cisco CTL Provider" service that is already stopped
	When we submit a request to stop "Cisco CTL Provider" service
	And the "Cisco CTL Provider" service is "stopped"
