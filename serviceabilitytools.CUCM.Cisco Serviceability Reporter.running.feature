#===============================================================================
#
# FILE: serviceabilitytools.CUCM.Cisco Serviceability Reporter.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco Serviceability Reporter" service
	...
	Scenario: Restart "Cisco Serviceability Reporter" service that is stopped
	When we submit a request to restart "Cisco Serviceability Reporter" service
	And the "Cisco Serviceability Reporter" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco Serviceability Reporter" service should be "STARTED"
	...
	Scenario: Start "Cisco Serviceability Reporter" service that is already started
	When we submit a request to start "Cisco Serviceability Reporter" service
	And the "Cisco Serviceability Reporter" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco Serviceability Reporter" service should be "STARTED"

	Scenario: Stop "Cisco Serviceability Reporter" service that is already stopped
	When we submit a request to stop "Cisco Serviceability Reporter" service
	And the "Cisco Serviceability Reporter" service is "stopped"
