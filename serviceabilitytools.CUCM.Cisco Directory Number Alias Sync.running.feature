#===============================================================================
#
# FILE: serviceabilitytools.CUCM.Cisco Directory Number Alias Sync.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco Directory Number Alias Sync" service
	...
	Scenario: Restart "Cisco Directory Number Alias Sync" service that is stopped
	When we submit a request to restart "Cisco Directory Number Alias Sync" service
	And the "Cisco Directory Number Alias Sync" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco Directory Number Alias Sync" service should be "STARTED"
	...
	Scenario: Start "Cisco Directory Number Alias Sync" service that is already started
	When we submit a request to start "Cisco Directory Number Alias Sync" service
	And the "Cisco Directory Number Alias Sync" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco Directory Number Alias Sync" service should be "STARTED"

	Scenario: Stop "Cisco Directory Number Alias Sync" service that is already stopped
	When we submit a request to stop "Cisco Directory Number Alias Sync" service
	And the "Cisco Directory Number Alias Sync" service is "stopped"
