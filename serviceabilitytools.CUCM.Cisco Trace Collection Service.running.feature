#===============================================================================
#
# FILE: serviceabilitytools.CUCM.Cisco Trace Collection Service.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco Trace Collection Service" service
	...
	Scenario: Restart "Cisco Trace Collection Service" service that is stopped
	When we submit a request to restart "Cisco Trace Collection Service" service
	And the "Cisco Trace Collection Service" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco Trace Collection Service" service should be "STARTED"
	...
	Scenario: Start "Cisco Trace Collection Service" service that is already started
	When we submit a request to start "Cisco Trace Collection Service" service
	And the "Cisco Trace Collection Service" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco Trace Collection Service" service should be "STARTED"

	Scenario: Stop "Cisco Trace Collection Service" service that is already stopped
	When we submit a request to stop "Cisco Trace Collection Service" service
	And the "Cisco Trace Collection Service" service is "stopped"
