#===============================================================================
#
# FILE: serviceabilitytools.CUCM.Cisco License Manager.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco License Manager" service
	...
	Scenario: Restart "Cisco License Manager" service that is stopped
	When we submit a request to restart "Cisco License Manager" service
	And the "Cisco License Manager" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco License Manager" service should be "STARTED"
	...
	Scenario: Start "Cisco License Manager" service that is already started
	When we submit a request to start "Cisco License Manager" service
	And the "Cisco License Manager" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco License Manager" service should be "STARTED"

	Scenario: Stop "Cisco License Manager" service that is already stopped
	When we submit a request to stop "Cisco License Manager" service
	And the "Cisco License Manager" service is "stopped"
