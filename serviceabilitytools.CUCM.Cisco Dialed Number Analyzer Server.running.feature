#===============================================================================
#
# FILE: serviceabilitytools.CUCM.Cisco Dialed Number Analyzer Server.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco Dialed Number Analyzer Server" service
	...
	Scenario: Restart "Cisco Dialed Number Analyzer Server" service that is stopped
	When we submit a request to restart "Cisco Dialed Number Analyzer Server" service
	And the "Cisco Dialed Number Analyzer Server" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco Dialed Number Analyzer Server" service should be "STARTED"
	...
	Scenario: Start "Cisco Dialed Number Analyzer Server" service that is already started
	When we submit a request to start "Cisco Dialed Number Analyzer Server" service
	And the "Cisco Dialed Number Analyzer Server" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco Dialed Number Analyzer Server" service should be "STARTED"

	Scenario: Stop "Cisco Dialed Number Analyzer Server" service that is already stopped
	When we submit a request to stop "Cisco Dialed Number Analyzer Server" service
	And the "Cisco Dialed Number Analyzer Server" service is "stopped"
