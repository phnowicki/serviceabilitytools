#===============================================================================
#
# FILE: serviceabilitytools.CUCM.Cisco UXL Web Service.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco UXL Web Service" service
	...
	Scenario: Restart "Cisco UXL Web Service" service that is stopped
	When we submit a request to restart "Cisco UXL Web Service" service
	And the "Cisco UXL Web Service" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco UXL Web Service" service should be "STARTED"
	...
	Scenario: Start "Cisco UXL Web Service" service that is already started
	When we submit a request to start "Cisco UXL Web Service" service
	And the "Cisco UXL Web Service" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco UXL Web Service" service should be "STARTED"

	Scenario: Stop "Cisco UXL Web Service" service that is already stopped
	When we submit a request to stop "Cisco UXL Web Service" service
	And the "Cisco UXL Web Service" service is "stopped"
