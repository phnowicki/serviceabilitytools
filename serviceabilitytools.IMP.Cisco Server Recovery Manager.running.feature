#===============================================================================
#
# FILE: serviceabilitytools.IMP.Cisco Server Recovery Manager.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco Server Recovery Manager" service
	...
	Scenario: Restart "Cisco Server Recovery Manager" service that is stopped
	When we submit a request to restart "Cisco Server Recovery Manager" service
	And the "Cisco Server Recovery Manager" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco Server Recovery Manager" service should be "STARTED"
	...
	Scenario: Start "Cisco Server Recovery Manager" service that is already started
	When we submit a request to start "Cisco Server Recovery Manager" service
	And the "Cisco Server Recovery Manager" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco Server Recovery Manager" service should be "STARTED"

	Scenario: Stop "Cisco Server Recovery Manager" service that is already stopped
	When we submit a request to stop "Cisco Server Recovery Manager" service
	And the "Cisco Server Recovery Manager" service is "stopped"
