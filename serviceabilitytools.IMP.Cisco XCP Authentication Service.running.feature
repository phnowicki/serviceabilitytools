#===============================================================================
#
# FILE: serviceabilitytools.IMP.Cisco XCP Authentication Service.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco XCP Authentication Service" service
	...
	Scenario: Restart "Cisco XCP Authentication Service" service that is stopped
	When we submit a request to restart "Cisco XCP Authentication Service" service
	And the "Cisco XCP Authentication Service" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco XCP Authentication Service" service should be "STARTED"
	...
	Scenario: Start "Cisco XCP Authentication Service" service that is already started
	When we submit a request to start "Cisco XCP Authentication Service" service
	And the "Cisco XCP Authentication Service" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco XCP Authentication Service" service should be "STARTED"

	Scenario: Stop "Cisco XCP Authentication Service" service that is already stopped
	When we submit a request to stop "Cisco XCP Authentication Service" service
	And the "Cisco XCP Authentication Service" service is "stopped"
