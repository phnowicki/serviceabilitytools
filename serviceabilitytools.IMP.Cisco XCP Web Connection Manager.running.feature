#===============================================================================
#
# FILE: serviceabilitytools.IMP.Cisco XCP Web Connection Manager.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco XCP Web Connection Manager" service
	...
	Scenario: Restart "Cisco XCP Web Connection Manager" service that is stopped
	When we submit a request to restart "Cisco XCP Web Connection Manager" service
	And the "Cisco XCP Web Connection Manager" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco XCP Web Connection Manager" service should be "STARTED"
	...
	Scenario: Start "Cisco XCP Web Connection Manager" service that is already started
	When we submit a request to start "Cisco XCP Web Connection Manager" service
	And the "Cisco XCP Web Connection Manager" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco XCP Web Connection Manager" service should be "STARTED"

	Scenario: Stop "Cisco XCP Web Connection Manager" service that is already stopped
	When we submit a request to stop "Cisco XCP Web Connection Manager" service
	And the "Cisco XCP Web Connection Manager" service is "stopped"
