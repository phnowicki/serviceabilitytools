#===============================================================================
#
# FILE: serviceabilitytools.CUCM.Cisco CallManager Admin.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco CallManager Admin" service
	...
	Scenario: Restart "Cisco CallManager Admin" service that is stopped
	When we submit a request to restart "Cisco CallManager Admin" service
	And the "Cisco CallManager Admin" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco CallManager Admin" service should be "STARTED"
	...
	Scenario: Start "Cisco CallManager Admin" service that is already started
	When we submit a request to start "Cisco CallManager Admin" service
	And the "Cisco CallManager Admin" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco CallManager Admin" service should be "STARTED"

	Scenario: Stop "Cisco CallManager Admin" service that is already stopped
	When we submit a request to stop "Cisco CallManager Admin" service
	And the "Cisco CallManager Admin" service is "stopped"
