#===============================================================================
#
# FILE: serviceabilitytools.CUCM.Cisco CallManager Serviceability.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco CallManager Serviceability" service
	...
	Scenario: Restart "Cisco CallManager Serviceability" service that is stopped
	When we submit a request to restart "Cisco CallManager Serviceability" service
	And the "Cisco CallManager Serviceability" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco CallManager Serviceability" service should be "STARTED"
	...
	Scenario: Start "Cisco CallManager Serviceability" service that is already started
	When we submit a request to start "Cisco CallManager Serviceability" service
	And the "Cisco CallManager Serviceability" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco CallManager Serviceability" service should be "STARTED"

	Scenario: Stop "Cisco CallManager Serviceability" service that is already stopped
	When we submit a request to stop "Cisco CallManager Serviceability" service
	And the "Cisco CallManager Serviceability" service is "stopped"
