#===============================================================================
#
# FILE: serviceabilitytools.CUCM.System Application Agent.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "System Application Agent" service
	...
	Scenario: Restart "System Application Agent" service that is stopped
	When we submit a request to restart "System Application Agent" service
	And the "System Application Agent" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "System Application Agent" service should be "STARTED"
	...
	Scenario: Start "System Application Agent" service that is already started
	When we submit a request to start "System Application Agent" service
	And the "System Application Agent" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "System Application Agent" service should be "STARTED"

	Scenario: Stop "System Application Agent" service that is already stopped
	When we submit a request to stop "System Application Agent" service
	And the "System Application Agent" service is "stopped"
