#===============================================================================
#
# FILE: serviceabilitytools.IMP.Cisco XCP Directory Service.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco XCP Directory Service" service
	...
	Scenario: Restart "Cisco XCP Directory Service" service that is stopped
	When we submit a request to restart "Cisco XCP Directory Service" service
	And the "Cisco XCP Directory Service" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco XCP Directory Service" service should be "STARTED"
	...
	Scenario: Start "Cisco XCP Directory Service" service that is already started
	When we submit a request to start "Cisco XCP Directory Service" service
	And the "Cisco XCP Directory Service" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco XCP Directory Service" service should be "STARTED"

	Scenario: Stop "Cisco XCP Directory Service" service that is already stopped
	When we submit a request to stop "Cisco XCP Directory Service" service
	And the "Cisco XCP Directory Service" service is "stopped"
