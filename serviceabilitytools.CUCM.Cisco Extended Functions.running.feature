#===============================================================================
#
# FILE: serviceabilitytools.CUCM.Cisco Extended Functions.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco Extended Functions" service
	...
	Scenario: Restart "Cisco Extended Functions" service that is stopped
	When we submit a request to restart "Cisco Extended Functions" service
	And the "Cisco Extended Functions" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco Extended Functions" service should be "STARTED"
	...
	Scenario: Start "Cisco Extended Functions" service that is already started
	When we submit a request to start "Cisco Extended Functions" service
	And the "Cisco Extended Functions" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco Extended Functions" service should be "STARTED"

	Scenario: Stop "Cisco Extended Functions" service that is already stopped
	When we submit a request to stop "Cisco Extended Functions" service
	And the "Cisco Extended Functions" service is "stopped"
