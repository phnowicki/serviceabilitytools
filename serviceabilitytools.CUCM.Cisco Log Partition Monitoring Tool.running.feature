#===============================================================================
#
# FILE: serviceabilitytools.CUCM.Cisco Log Partition Monitoring Tool.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco Log Partition Monitoring Tool" service
	...
	Scenario: Restart "Cisco Log Partition Monitoring Tool" service that is stopped
	When we submit a request to restart "Cisco Log Partition Monitoring Tool" service
	And the "Cisco Log Partition Monitoring Tool" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco Log Partition Monitoring Tool" service should be "STARTED"
	...
	Scenario: Start "Cisco Log Partition Monitoring Tool" service that is already started
	When we submit a request to start "Cisco Log Partition Monitoring Tool" service
	And the "Cisco Log Partition Monitoring Tool" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco Log Partition Monitoring Tool" service should be "STARTED"

	Scenario: Stop "Cisco Log Partition Monitoring Tool" service that is already stopped
	When we submit a request to stop "Cisco Log Partition Monitoring Tool" service
	And the "Cisco Log Partition Monitoring Tool" service is "stopped"
