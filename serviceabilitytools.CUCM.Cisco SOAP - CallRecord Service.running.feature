#===============================================================================
#
# FILE: serviceabilitytools.CUCM.Cisco SOAP - CallRecord Service.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco SOAP - CallRecord Service" service
	...
	Scenario: Restart "Cisco SOAP - CallRecord Service" service that is stopped
	When we submit a request to restart "Cisco SOAP - CallRecord Service" service
	And the "Cisco SOAP - CallRecord Service" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco SOAP - CallRecord Service" service should be "STARTED"
	...
	Scenario: Start "Cisco SOAP - CallRecord Service" service that is already started
	When we submit a request to start "Cisco SOAP - CallRecord Service" service
	And the "Cisco SOAP - CallRecord Service" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco SOAP - CallRecord Service" service should be "STARTED"

	Scenario: Stop "Cisco SOAP - CallRecord Service" service that is already stopped
	When we submit a request to stop "Cisco SOAP - CallRecord Service" service
	And the "Cisco SOAP - CallRecord Service" service is "stopped"
