#===============================================================================
#
# FILE: serviceabilitytools.CUCM.Cisco Database Layer Monitor.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco Database Layer Monitor" service
	...
	Scenario: Restart "Cisco Database Layer Monitor" service that is stopped
	When we submit a request to restart "Cisco Database Layer Monitor" service
	And the "Cisco Database Layer Monitor" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco Database Layer Monitor" service should be "STARTED"
	...
	Scenario: Start "Cisco Database Layer Monitor" service that is already started
	When we submit a request to start "Cisco Database Layer Monitor" service
	And the "Cisco Database Layer Monitor" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco Database Layer Monitor" service should be "STARTED"

	Scenario: Stop "Cisco Database Layer Monitor" service that is already stopped
	When we submit a request to stop "Cisco Database Layer Monitor" service
	And the "Cisco Database Layer Monitor" service is "stopped"
