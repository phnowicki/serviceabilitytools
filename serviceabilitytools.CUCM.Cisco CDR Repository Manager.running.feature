#===============================================================================
#
# FILE: serviceabilitytools.CUCM.Cisco CDR Repository Manager.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco CDR Repository Manager" service
	...
	Scenario: Restart "Cisco CDR Repository Manager" service that is stopped
	When we submit a request to restart "Cisco CDR Repository Manager" service
	And the "Cisco CDR Repository Manager" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco CDR Repository Manager" service should be "STARTED"
	...
	Scenario: Start "Cisco CDR Repository Manager" service that is already started
	When we submit a request to start "Cisco CDR Repository Manager" service
	And the "Cisco CDR Repository Manager" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco CDR Repository Manager" service should be "STARTED"

	Scenario: Stop "Cisco CDR Repository Manager" service that is already stopped
	When we submit a request to stop "Cisco CDR Repository Manager" service
	And the "Cisco CDR Repository Manager" service is "stopped"
