#===============================================================================
#
# FILE: serviceabilitytools.IMP.Cisco IM and Presence Data Monitor.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco IM and Presence Data Monitor" service
	...
	Scenario: Restart "Cisco IM and Presence Data Monitor" service that is stopped
	When we submit a request to restart "Cisco IM and Presence Data Monitor" service
	And the "Cisco IM and Presence Data Monitor" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco IM and Presence Data Monitor" service should be "STARTED"
	...
	Scenario: Start "Cisco IM and Presence Data Monitor" service that is already started
	When we submit a request to start "Cisco IM and Presence Data Monitor" service
	And the "Cisco IM and Presence Data Monitor" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco IM and Presence Data Monitor" service should be "STARTED"

	Scenario: Stop "Cisco IM and Presence Data Monitor" service that is already stopped
	When we submit a request to stop "Cisco IM and Presence Data Monitor" service
	And the "Cisco IM and Presence Data Monitor" service is "stopped"
