#===============================================================================
#
# FILE: serviceabilitytools.IMP.Cisco XCP Text Conference Manager.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco XCP Text Conference Manager" service
	...
	Scenario: Restart "Cisco XCP Text Conference Manager" service that is stopped
	When we submit a request to restart "Cisco XCP Text Conference Manager" service
	And the "Cisco XCP Text Conference Manager" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco XCP Text Conference Manager" service should be "STARTED"
	...
	Scenario: Start "Cisco XCP Text Conference Manager" service that is already started
	When we submit a request to start "Cisco XCP Text Conference Manager" service
	And the "Cisco XCP Text Conference Manager" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco XCP Text Conference Manager" service should be "STARTED"

	Scenario: Stop "Cisco XCP Text Conference Manager" service that is already stopped
	When we submit a request to stop "Cisco XCP Text Conference Manager" service
	And the "Cisco XCP Text Conference Manager" service is "stopped"
