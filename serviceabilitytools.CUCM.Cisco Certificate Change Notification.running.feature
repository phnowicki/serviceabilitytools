#===============================================================================
#
# FILE: serviceabilitytools.CUCM.Cisco Certificate Change Notification.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco Certificate Change Notification" service
	...
	Scenario: Restart "Cisco Certificate Change Notification" service that is stopped
	When we submit a request to restart "Cisco Certificate Change Notification" service
	And the "Cisco Certificate Change Notification" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco Certificate Change Notification" service should be "STARTED"
	...
	Scenario: Start "Cisco Certificate Change Notification" service that is already started
	When we submit a request to start "Cisco Certificate Change Notification" service
	And the "Cisco Certificate Change Notification" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco Certificate Change Notification" service should be "STARTED"

	Scenario: Stop "Cisco Certificate Change Notification" service that is already stopped
	When we submit a request to stop "Cisco Certificate Change Notification" service
	And the "Cisco Certificate Change Notification" service is "stopped"
