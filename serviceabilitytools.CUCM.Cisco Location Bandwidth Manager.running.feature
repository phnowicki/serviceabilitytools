#===============================================================================
#
# FILE: serviceabilitytools.CUCM.Cisco Location Bandwidth Manager.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco Location Bandwidth Manager" service
	...
	Scenario: Restart "Cisco Location Bandwidth Manager" service that is stopped
	When we submit a request to restart "Cisco Location Bandwidth Manager" service
	And the "Cisco Location Bandwidth Manager" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco Location Bandwidth Manager" service should be "STARTED"
	...
	Scenario: Start "Cisco Location Bandwidth Manager" service that is already started
	When we submit a request to start "Cisco Location Bandwidth Manager" service
	And the "Cisco Location Bandwidth Manager" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco Location Bandwidth Manager" service should be "STARTED"

	Scenario: Stop "Cisco Location Bandwidth Manager" service that is already stopped
	When we submit a request to stop "Cisco Location Bandwidth Manager" service
	And the "Cisco Location Bandwidth Manager" service is "stopped"
