#===============================================================================
#
# FILE: serviceabilitytools.CUCM.Cisco DHCP Monitor Service.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco DHCP Monitor Service" service
	...
	Scenario: Restart "Cisco DHCP Monitor Service" service that is stopped
	When we submit a request to restart "Cisco DHCP Monitor Service" service
	And the "Cisco DHCP Monitor Service" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco DHCP Monitor Service" service should be "STARTED"
	...
	Scenario: Start "Cisco DHCP Monitor Service" service that is already started
	When we submit a request to start "Cisco DHCP Monitor Service" service
	And the "Cisco DHCP Monitor Service" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco DHCP Monitor Service" service should be "STARTED"

	Scenario: Stop "Cisco DHCP Monitor Service" service that is already stopped
	When we submit a request to stop "Cisco DHCP Monitor Service" service
	And the "Cisco DHCP Monitor Service" service is "stopped"
