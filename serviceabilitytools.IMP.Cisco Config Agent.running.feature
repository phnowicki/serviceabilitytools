#===============================================================================
#
# FILE: serviceabilitytools.IMP.Cisco Config Agent.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco Config Agent" service
	...
	Scenario: Restart "Cisco Config Agent" service that is stopped
	When we submit a request to restart "Cisco Config Agent" service
	And the "Cisco Config Agent" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco Config Agent" service should be "STARTED"
	...
	Scenario: Start "Cisco Config Agent" service that is already started
	When we submit a request to start "Cisco Config Agent" service
	And the "Cisco Config Agent" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco Config Agent" service should be "STARTED"

	Scenario: Stop "Cisco Config Agent" service that is already stopped
	When we submit a request to stop "Cisco Config Agent" service
	And the "Cisco Config Agent" service is "stopped"
