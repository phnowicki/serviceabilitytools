#===============================================================================
#
# FILE: serviceabilitytools.CUCM.Cisco SOAP - CDRonDemand Service.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco SOAP - CDRonDemand Service" service
	...
	Scenario: Restart "Cisco SOAP - CDRonDemand Service" service that is stopped
	When we submit a request to restart "Cisco SOAP - CDRonDemand Service" service
	And the "Cisco SOAP - CDRonDemand Service" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco SOAP - CDRonDemand Service" service should be "STARTED"
	...
	Scenario: Start "Cisco SOAP - CDRonDemand Service" service that is already started
	When we submit a request to start "Cisco SOAP - CDRonDemand Service" service
	And the "Cisco SOAP - CDRonDemand Service" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco SOAP - CDRonDemand Service" service should be "STARTED"

	Scenario: Stop "Cisco SOAP - CDRonDemand Service" service that is already stopped
	When we submit a request to stop "Cisco SOAP - CDRonDemand Service" service
	And the "Cisco SOAP - CDRonDemand Service" service is "stopped"
