#===============================================================================
#
# FILE: serviceabilitytools.CUCM.Cisco TAPS Service.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco TAPS Service" service
	...
	Scenario: Restart "Cisco TAPS Service" service that is stopped
	When we submit a request to restart "Cisco TAPS Service" service
	And the "Cisco TAPS Service" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco TAPS Service" service should be "STARTED"
	...
	Scenario: Start "Cisco TAPS Service" service that is already started
	When we submit a request to start "Cisco TAPS Service" service
	And the "Cisco TAPS Service" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco TAPS Service" service should be "STARTED"

	Scenario: Stop "Cisco TAPS Service" service that is already stopped
	When we submit a request to stop "Cisco TAPS Service" service
	And the "Cisco TAPS Service" service is "stopped"
