#===============================================================================
#
# FILE: serviceabilitytools.CUCM.Cisco IP Manager Assisistant.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco IP Manager Assisistant" service
	...
	Scenario: Restart "Cisco IP Manager Assisistant" service that is stopped
	When we submit a request to restart "Cisco IP Manager Assisistant" service
	And the "Cisco IP Manager Assisistant" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco IP Manager Assisistant" service should be "STARTED"
	...
	Scenario: Start "Cisco IP Manager Assisistant" service that is already started
	When we submit a request to start "Cisco IP Manager Assisistant" service
	And the "Cisco IP Manager Assisistant" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco IP Manager Assisistant" service should be "STARTED"

	Scenario: Stop "Cisco IP Manager Assisistant" service that is already stopped
	When we submit a request to stop "Cisco IP Manager Assisistant" service
	And the "Cisco IP Manager Assisistant" service is "stopped"
