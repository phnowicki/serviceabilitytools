#===============================================================================
#
# FILE: serviceabilitytools.CUCM.Cisco Certificate Expiry Monitor.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco Certificate Expiry Monitor" service
	...
	Scenario: Restart "Cisco Certificate Expiry Monitor" service that is stopped
	When we submit a request to restart "Cisco Certificate Expiry Monitor" service
	And the "Cisco Certificate Expiry Monitor" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco Certificate Expiry Monitor" service should be "STARTED"
	...
	Scenario: Start "Cisco Certificate Expiry Monitor" service that is already started
	When we submit a request to start "Cisco Certificate Expiry Monitor" service
	And the "Cisco Certificate Expiry Monitor" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco Certificate Expiry Monitor" service should be "STARTED"

	Scenario: Stop "Cisco Certificate Expiry Monitor" service that is already stopped
	When we submit a request to stop "Cisco Certificate Expiry Monitor" service
	And the "Cisco Certificate Expiry Monitor" service is "stopped"
