#===============================================================================
#
# FILE: serviceabilitytools.CUCM.Cisco CallManager SNMP Service.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco CallManager SNMP Service" service
	...
	Scenario: Restart "Cisco CallManager SNMP Service" service that is stopped
	When we submit a request to restart "Cisco CallManager SNMP Service" service
	And the "Cisco CallManager SNMP Service" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco CallManager SNMP Service" service should be "STARTED"
	...
	Scenario: Start "Cisco CallManager SNMP Service" service that is already started
	When we submit a request to start "Cisco CallManager SNMP Service" service
	And the "Cisco CallManager SNMP Service" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco CallManager SNMP Service" service should be "STARTED"

	Scenario: Stop "Cisco CallManager SNMP Service" service that is already stopped
	When we submit a request to stop "Cisco CallManager SNMP Service" service
	And the "Cisco CallManager SNMP Service" service is "stopped"
