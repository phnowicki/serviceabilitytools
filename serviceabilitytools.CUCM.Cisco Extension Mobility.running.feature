#===============================================================================
#
# FILE: serviceabilitytools.CUCM.Cisco Extension Mobility.running.feature
#
...
And the following user credentials
	...
	When we submit a request to stop "Cisco Extension Mobility" service
	...
	Scenario: Restart "Cisco Extension Mobility" service that is stopped
	When we submit a request to restart "Cisco Extension Mobility" service
	And the "Cisco Extension Mobility" service is "stopped"
	Then we should receive "STARTED" message
	And the status of "Cisco Extension Mobility" service should be "STARTED"
	...
	Scenario: Start "Cisco Extension Mobility" service that is already started
	When we submit a request to start "Cisco Extension Mobility" service
	And the "Cisco Extension Mobility" service is "started"
	Then we should receive "ALREADY STARTED" message
	And the status of "Cisco Extension Mobility" service should be "STARTED"

	Scenario: Stop "Cisco Extension Mobility" service that is already stopped
	When we submit a request to stop "Cisco Extension Mobility" service
	And the "Cisco Extension Mobility" service is "stopped"
